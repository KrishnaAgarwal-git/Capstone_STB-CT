...
function SignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const result = await register({ firstName, lastName, email, password, region });
      toast.success('Account created — check your email to verify.');
      navigate('/check-email', { replace: true, state: { email: result.email || email } });
    } catch (err) {
  ...
  return (
    <div className="signup-page">
      ...
      <div className="signup-container">
        <Link to="/" className="signup-brand" aria-label="Back to home">
        ...
        <div className="signup-card spotlight" onMouseMove={spotlightMove}>
